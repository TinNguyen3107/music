...
const mockFriends = [
  ['mock-friend-01', 'An Nhiên', '#8101', '/artwork/flowers.webp', 'Thích nhạc chill, ảnh nắng chiều và vài câu chuyện nhỏ.', 0],
  ['mock-friend-02', 'Bảo Trân', '#8102', '/artwork/coffee.webp', 'Hay gửi lời chào vào buổi sáng.', 45_000],
  ['mock-friend-03', 'Minh Khang', '#8103', '/artwork/forest.webp', 'Đi đâu cũng mang tai nghe.', 2 * 60_000],
  ['mock-friend-04', 'Gia Hân', '#8104', '/artwork/tea.webp', 'Một người bạn thích trà nóng và playlist dịu.', 7 * 60_000],
  ['mock-friend-05', 'Duy Anh', '#8105', '/artwork/night.webp', 'Online trễ, nghe nhạc đêm nhiều hơn ban ngày.', 17 * 60_000],
  ['mock-friend-06', 'Linh Chi', '#8106', '/artwork/reading.webp', 'Lưu lại kỷ niệm bằng vài dòng rất ngắn.', 34 * 60_000],
  ['mock-friend-07', 'Quỳnh Mai', '#8107', '/artwork/desk.webp', 'Đang test giao diện bạn bè nhiều người.', 58 * 60_000],
  ['mock-friend-08', 'Hoàng Nam', '#8108', '/artwork/evening.webp', 'Gu nhạc hơi buồn một chút.', 2 * 60 * 60_000],
  ['mock-friend-09', 'Tuấn Kiệt', '#8109', '/artwork/sleeve.webp', 'Bạn mẫu để kiểm tra trạng thái hoạt động.', 5 * 60 * 60_000],
  ['mock-friend-10', 'Mộc Lam', '#8110', '/artwork/flowers.webp', 'Thích gửi ảnh trong chat.', 9 * 60 * 60_000],
  ['mock-friend-11', 'Hải Yến', '#8111', '/artwork/coffee.webp', 'Một chiếc bio dài hơn một chút để xem card profile có bị vỡ layout trên màn hình nhỏ hay không.', 18 * 60 * 60_000],
  ['mock-friend-12', 'Thanh Vy', '#8112', '/artwork/forest.webp', 'Thỉnh thoảng mới online.', 26 * 60 * 60_000],
  ['mock-friend-13', 'Phúc Lâm', '#8113', '/artwork/tea.webp', 'Bạn bè mẫu số 13.', 2 * 24 * 60 * 60_000],
  ['mock-friend-14', 'Ngọc Ánh', '#8114', '/artwork/night.webp', 'Bạn bè mẫu số 14.', 3 * 24 * 60 * 60_000],
  ['mock-friend-15', 'Khánh Linh', '#8115', '/artwork/reading.webp', 'Bạn bè mẫu số 15.', 4 * 24 * 60 * 60_000],
  ['mock-friend-16', 'Trúc Ly', '#8116', '/artwork/desk.webp', 'Bạn bè mẫu số 16.', 5 * 24 * 60 * 60_000],
  ['mock-friend-17', 'Đức Minh', '#8117', '/artwork/evening.webp', 'Bạn bè mẫu số 17.', 6 * 24 * 60 * 60_000],
