...
const sqliteSchema = `
  ...
  CREATE TABLE IF NOT EXISTS users (id TEXT PRIMARY KEY,name TEXT NOT NULL,email TEXT NOT NULL UNIQUE,publicId TEXT UNIQUE,avatar TEXT,bio TEXT DEFAULT '',passwordHash TEXT NOT NULL,salt TEXT NOT NULL,lastActiveAt TEXT,createdAt TEXT NOT NULL);
